...
Agent.prototype.ensureConnection = function () {
  ...
  // If the transport is already connected, return
  if (this._connected === true) {
    return
  }
  // Connect to transport and mark the agent as connected
  this._transport = this._conf.transport(this._conf, this)
  this._connected = true
  // On close, mark the agent as not connected
  const disconnect = () => {
    this._connected = false
  }
  this._transport.once('error', disconnect)
  this._transport.once('close', disconnect)
}
